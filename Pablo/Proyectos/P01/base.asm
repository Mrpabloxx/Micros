;******************************************************************************
; P0101.asm
; Created: 25/08/2019 2:39:21 p. m.
; Author : Pablo Esteban Martínez García
;******************************************************************************
;	Revisar en:
...
Aqui: 
	rjmp Aqui
;******************************************************************************
; Detectar etiquetas, instrucciones
; para construir el codigo en el programa ensablador, usar el comando "build-> rebuild solution ctrl+Alt+F7
;